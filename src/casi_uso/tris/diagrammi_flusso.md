...
Il diagramma di flusso del server mostra le principali operazioni che il programma esegue per gestire le connessioni con 2 client e una partita di Tris.
...
<div style="text-align: center;"><img height="1000" src="../../assets/tris/tris_flowchart.png" alt="Program Flowchart"/></div>